...
<body style="background-color : #E4CBCB">
<?php
    include 'config.php';
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group button">
              <input class="app-form-button" style="color:black;" type="submit" value="CREATE USER" name="submit"></input>
              <input class="app-form-button" style="color:black;" type="reset" value="RESET" name="reset"></input>
            </div>
          </form>
        </div>
      </div>
